  ...
  return (
    <div className="flex min-h-screen bg-gradient-to-br from-pink-50 to-purple-100">
      <div
        ...
        style={{
          backgroundImage:
            "url('https://images.unsplash.com/photo-1584263347416-85a3274855ef?q=80&w=1000&auto=format&fit=crop')",
        }}
      >
        <div className="flex flex-col justify-end p-12 bg-gradient-to-t from-purple-900/60 to-transparent h-full w-full">
          ...
          <p className="text-white/90 text-lg">
            Personalized insights for your body's natural rhythm
          </p>
        </div>
      </div>
      ...
      <div className="w-full lg:w-1/2 flex flex-col items-center justify-center p-8">
        <div className="w-full max-w-md">
          ...
          <form onSubmit={handleLogin} className="space-y-6">
            ...
            <button
              type="submit"
              className="w-full bg-purple-600 hover:bg-purple-700 text-white font-medium py-3 px-4 rounded-lg transition duration-150 ease-in-out shadow-md hover:shadow-lg"
            >
              Log In
            </button>
          </form>
